...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PuffedneyStudent cedric = generatePuffendeyStudent("Седрик Диггори");
        harry.print();
        ron.print();
        luna.print();
        draco.print();
    ...
    private static PuffedneyStudent generatePuffendeyStudent(String name) {
        return new PuffedneyStudent(
                name,
                RANDOM.nextInt(100),
                RANDOM.nextInt(100),
                RANDOM.nextInt(100),
